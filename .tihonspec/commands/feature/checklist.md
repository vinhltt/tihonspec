...
4. **Validate task_id format**:
   ...
   - Examples:
     - ✅ `/feature.checklist pref-001` → task_id: `pref-001`
     - ✅ `/feature.checklist PREF-001` → task_id: `pref-001` (case-insensitive)
     - ❌ `/feature.checklist` without context → ERROR (no task ID)
